      ...
      <Card className="bg-card/80 backdrop-blur-sm">
        ...
        <CardContent className="p-4 sm:p-6 pt-0">
          <Tabs value={activeTab} onValueChange={handleTabChange}>
            <TabsList className="flex flex-wrap justify-center gap-2 sm:gap-3 p-2 sm:p-3 h-auto bg-muted/50">
              <TabsTrigger value="daily" className="text-xs sm:text-sm py-2 sm:py-3 px-3 sm:px-4 flex-1 min-w-[80px] sm:min-w-[120px]">
                <Calendar className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2" />
                <span className="hidden xs:inline">Дневен</span>
                <span className="xs:hidden">Ден</span>
              </TabsTrigger>
              <TabsTrigger value="weekly" className="text-xs sm:text-sm py-2 sm:py-3 px-3 sm:px-4 flex-1 min-w-[80px] sm:min-w-[120px]">
                <TrendingUp className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2" />
                <span className="hidden xs:inline">Седмичен</span>
                <span className="xs:hidden">Седм</span>
              </TabsTrigger>
              <TabsTrigger value="monthly" className="text-xs sm:text-sm py-2 sm:py-3 px-3 sm:px-4 flex-1 min-w-[80px] sm:min-w-[120px]">
                <Star className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2" />
                <span className="hidden xs:inline">Месечен</span>
                <span className="xs:hidden">Мес</span>
              </TabsTrigger>
              <TabsTrigger value="yearly" className="text-xs sm:text-sm py-2 sm:py-3 px-3 sm:px-4 flex-1 min-w-[80px] sm:min-w-[120px]">
                <Star className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2" />
                <span className="hidden xs:inline">Годишен</span>
                <span className="xs:hidden">Год</span>
              </TabsTrigger>
            </TabsList>
